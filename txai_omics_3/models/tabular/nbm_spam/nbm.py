import torch
from txai_omics_3.models.tabular.base import BaseModel
from txai_omics_3.models.tabular.nbm_spam.repository.concept_nbm import ConceptNBMNary


class NBMModel(BaseModel):
