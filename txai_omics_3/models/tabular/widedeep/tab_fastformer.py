from txai_omics_3.models.tabular.widedeep.base import WDBaseModel
from pytorch_widedeep.models import TabFastFormer


class WDTabFastFormerModel(WDBaseModel):

    def __init__(self, **kwargs):
        super().__init__(**kwargs)

    def build_network(self):
        self.model = TabFastFormer(
            ...
            share_qv_weights=self.hparams.share_qv_weights,
