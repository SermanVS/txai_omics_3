...
def main(config: DictConfig):
    ...
    from txai_omics_3.tasks.regression.trn_val_tst import trn_val_tst_regression
    from txai_omics_3.tasks.classification.trn_val_tst import trn_val_tst_classification
